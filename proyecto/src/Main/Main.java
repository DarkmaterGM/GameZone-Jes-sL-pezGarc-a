...
public class Main {
        ...
        try {
            switch (leerInt()) {
                ...
                case 2 -> {
                    ...
                    System.out.println(c != null ? c : "Categoría no encontrada.");
                }
                case 3 -> {
    ...
    private static void menuVentas() {
        ...
        } catch (ClienteNoEncontradoException | EmpleadoNoEncontradoException | VentaNoEncontradoException e) {
            System.err.println(e.getMessage());
        } catch (SQLException e) {
            System.err.println("Error SQL: " + e.getMessage());
        }
        ...
        try {
            switch (leerInt()) {
                ...
                case 2 -> {
                    ...
                    List<Detalle_venta> lista = detalleVentaDAO.listarPorProducto(Integer.parseInt(idProd));
                ...
                case 3 -> {
                    ...
                    System.out.print("ID del producto: "); int idProd  = leerInt();
                ...
                case 4 -> {
                    ...
                    boolean ok = detalleVentaDAO.insertar(new Detalle_venta(0, idVenta, idProd, cant, precio));
                ...
                case 5 -> {
                    ...
                    boolean ok = detalleVentaDAO.actualizar(new Detalle_venta(0, idVenta, idProd, cant, precio));
    ...
    private static Cliente leerClienteConDni(String dni) {
        ...
        return new Cliente(dni, nom, ap1, ap2.isEmpty() ? null : ap2, tel,
                           email.isEmpty() ? null : email, dir);
    }
    ...
    private static Venta leerVenta() {
        System.out.print("ID de la venta: "); int id = leerInt();
    ...
    /** Lee un int consumiendo el salto de línea posterior. */
    ...
    /** Lee un double consumiendo el salto de línea posterior. */
