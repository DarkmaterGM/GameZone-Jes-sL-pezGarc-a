...
public class CategoriaD {
    ...
    // INSERT
    // El id se pasa aparte porque el DTO Categoria no lo contiene

    public boolean insertar(String id, Categoria categoria) throws SQLException {
    ...
    public Categoria buscarPorId(String id) throws SQLException {
        String sql = "SELECT Nombre, Descripcion FROM CATEGORIA WHERE id = ?";
    ...
    public List<Categoria> listarTodos() throws SQLException {
        String sql = "SELECT Nombre, Descripcion FROM CATEGORIA ORDER BY Nombre";
