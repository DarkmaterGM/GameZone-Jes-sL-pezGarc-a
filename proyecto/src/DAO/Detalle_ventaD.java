...
public class Detalle_ventaD {
    ...
    public Detalle_venta buscarPorPk(int idVenta, String idProducto) throws SQLException {
    ...
    public List<Detalle_venta> listarPorProducto(String idProducto) throws SQLException {
    ...
    public boolean actualizar(Detalle_venta detalle) throws SQLException {
        ...
        try (PreparedStatement ps = connection.prepareStatement(sql)) {
            ...
            ps.setString(4, detalle.getId_producto());
            return ps.executeUpdate() > 0;
        }
    }
    ...
    public boolean eliminar(int idVenta, String idProducto) throws SQLException {
